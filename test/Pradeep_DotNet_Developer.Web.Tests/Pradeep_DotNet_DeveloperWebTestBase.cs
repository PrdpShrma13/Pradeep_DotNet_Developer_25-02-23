...
{
    public abstract class Pradeep_DotNet_DeveloperWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Pradeep_DotNet_DeveloperWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Pradeep_DotNet_DeveloperWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<Pradeep_DotNet_DeveloperDbContext> action)
        {
            using (var context = IocManager.Resolve<Pradeep_DotNet_DeveloperDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<Pradeep_DotNet_DeveloperDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<Pradeep_DotNet_DeveloperDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Pradeep_DotNet_DeveloperDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Pradeep_DotNet_DeveloperDbContext, Task<T>> func)
        {
            T result;

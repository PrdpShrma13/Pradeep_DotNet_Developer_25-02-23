...
namespace Pradeep_DotNet_Developer.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = Pradeep_DotNet_DeveloperConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(Pradeep_DotNet_DeveloperDbContext context)
        {
            _context = context;
        }
